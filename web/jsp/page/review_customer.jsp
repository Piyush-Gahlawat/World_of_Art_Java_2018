    ...
    <body><div class="content">
            ...
            <div class="content">
                ...
                int count=0;
                               ...
                               String id = String.valueOf(session.getAttribute("customer"));
                            ...
                            <table border="2">
                                    ...
                                    <td>
                                        <table border="4">
                                            ...
                                            <tr>
                                                ...
                                                <td class="rating">
                                                    <form action="rateit.jsp" name="strrate" onsubmit="return(validatestar())" method="post">
                                                        ...
                                                        <input type="submit" class="formbutton" name="Rate">
                                                    </form>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td><form action="add_review.jsp" name="revbox" onsubmit="return(validaterev())" method="post"> 
                                            <table class="addrev" >
                                                <tr>
                                                    <td>
                                                        <input type="hidden" value="<%=cid%>" name="c_id"/>
                                                        <input type="hidden" value="<%=art_id%>" name="art_id"/>
                                                        <textarea class="revtextfeild" row="5" column="50" name="review" placeholder="Add Review"></textarea>
                                                    </td><td><input type="submit" class="revbutton" value="Add Review">
                                                    </td>
                                                </tr>
                                            </table>
                                        </form>
