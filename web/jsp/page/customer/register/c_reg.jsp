...
long uid;
            ...
            %>
            <%
                aid = String.valueOf(session.getAttribute("creg"));
                ...
                try (Connection con = DriverManager.getConnection(dburl, dbuser, dbpass)) {
                    query = "insert into customerdb values(?,?,?,?,?,?,?,md5(?),?,?)";
                            q2 = "insert into c_security_question values(?,?,?,md5(?))";
            ...
            <%
                ...
                p2.close();} catch (IOException | SQLException ex) {
                    out.println(ex);
                }
            } else {
