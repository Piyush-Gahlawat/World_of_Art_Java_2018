...
<html>
    ...
    <body>
        <div class="content">
                            ...
                            try (ResultSet rs = ps.executeQuery()) {
                                if (rs.next()) {
                                    ...
                                    if (bflag.equals("0")) {
                                        ...
                                        String password = rs.getString("c_pass");
            ...
            Valid Credentials
            <br/>
            <input type="button" class="formbutton" value="Home" onclick="redirect('<%=request.getContextPath()%>/home.jsp');">
            <%
            } else {
            %>
