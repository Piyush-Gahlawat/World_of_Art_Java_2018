...
%>
        ...
        <%
            ...
            if (gender.equals("Male")) {
                state = fname + " " + lname + " has requested to update his email";
            } else if (gender.equals("Female")) {
                state = fname + " " + lname + " has requested to update her email";
            } else {
                state = fname + " " + lname + " has requested to update email";
            }
            String query = "update customerdb set c_email ='" + email + "' where c_id='" + id + "'";
