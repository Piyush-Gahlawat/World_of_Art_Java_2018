...
private String dbpass=getdata.password();
            %>
            <%
                uid = request.getParameter("c_id");
                id = Long.parseLong(uid);
                q1 = "Select * from customerdb where c_id=?";
                q2 = "update customerdb set c_block_f='1' where c_id=?";
            ...
            %>
            <input type="button" class="c" value="Home" onclick="redirect('<%=request.getContextPath()%>/home.jsp');">
            <%
            } else {
